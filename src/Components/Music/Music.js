...
let items=[
  ...
  {name:'Alhambra.mp3',display:'Recuerdos de la Alhambra by Francisco Tárrega'},
  {name:'PylonSong.mp3',display:' Etude E Minor by Mauro Giuliani'},
  {name:'Estudio.mp3',display:'Estudio in E Minor for Classical Guitar by Francisco Tárrega'},
